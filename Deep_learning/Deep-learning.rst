...
***********************
First, you’ll need to install the open-source ROCm 2.3 stack. Details can be found here: https://github.com/RadeonOpenCompute/ROCm
...
The ROCm 2.3 has prebuilt packages for MIOpen
***********************************************
...
A ROCm install version 2.3 is required currently.
